...
class ARACNEWrapper(NetworkInferenceWrapper):
    ...
    def _infer_network(self, expression_data, rank):
        ...
        assert os.path.exists(os.path.join(main, 'algorithms', 'ARACNe-AP')), 'download algorithms directory from\
        ...
        # run ARACNe:
        exe = os.path.join(main, 'algorithms', 'ARACNe-AP', 'dist','aracne.jar')
